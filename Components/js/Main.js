...
function checker() {
    ...
    if (tracker.regTracker === 'done') {
        // vote start checker
        Timer2('Jun 11, 2022 09:43:00', 'voteTimer2', 'voteMainButton', 'voting process has started');
    }

    // time can be got from the database
    if (tracker.voteTracker === 'startvote') {
        Timer3('Jun 12, 2022 13:50:00', 'voteTimer2', 'voteMainButton', 'voting process has ended');
    }
}

// pass time from the database
Timer('Jun 12, 2022 13:40:00', 'voteTimer', 'registerMainButton', 'Registration ended');
